...
>
> 3. Sample $$2\lceil \log n \rceil$$ spanning trees $$T_1, \dots, T_{2\lceil \log n \rceil}$$ from $$\tilde{p}(.)$$.
...
Now, for all values of $$e$$, $$e_1, e_2, \dots, e_{n-1}$$ in the spanning tree $$T$$ that product can be expanded as
