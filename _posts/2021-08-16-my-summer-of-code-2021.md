...
Multiplying my original value of $$q_e(\gamma)$$ by $$\exp(\gamma_e)$$ proved to be the solution here for reasons extensively discussed in my blog post *The Entropy Distribution* and in particular the "Update! (28 July 2021)" section.
...
[Can sample spanning trees](https://github.com/mjschwenne/networkx/commit/68f0cf95565bcdce0aec4678e3af9815e23b494e) - *Streamlined finding $$q_e(\gamma)$$ using new helper function*
