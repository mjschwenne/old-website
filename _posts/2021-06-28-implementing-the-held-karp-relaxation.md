...
In my last post, titled [*Understanding the Ascent Method*](https://mjschwenne.github.io/2021/06/22/understanding-the-ascent-method.html), I completed the first iteration of the ascent method and found an important bug in the `find_epsilon()` method and found a more efficient way to determine substitutes in the graph.
...
> Vertex $$i$$ is said to be *out-of-kilter high* at the point $$\pi$$, if, for all $$k \in K(\pi), v_{ik} \geqq 1$$;
> similarly, vertex $$i$$ is *out-of-kilter low* at the point $$\pi$$ if, for all $$k \in K(\pi), v_{ik} = -1$$.
...
| ![minimum 1 trees](/assets/minimum-1-trees-iteration-1.png) | ![minimum 1 arborescences](/assets/minimum-1-arborescences-iteration-1.png) |
...
| Iteration 2: |
| Minimum 1-Trees: | Minimum 1-Arborescences: |
| ![minimum 1 trees](/assets/minimum-1-trees-iteration-2.png) | ![minimum 1 arborescences](/assets/minimum-1-arborescences-iteration-2.png) |
...
<center><img src="/assets/true-minimum-arborescences.png"/></center>
